...
from agents.qlearning_agent import QNAgent
...
def train(args):
    ...
    if args.algorithm == 'qn':
        agent = QNAgent(num_actions=env.num_actions)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("QN example in RLCard")
    ...
    parser.add_argument('--algorithm', type=str, default='qn', choices=['qn'])
    parser.add_argument('--cuda', type=str, default='')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--num_episodes', type=int, default=200)
    parser.add_argument('--num_eval_games', type=int, default=2000)
    parser.add_argument('--evaluate_every', type=int, default=100)
    parser.add_argument('--log_dir', type=str, default='experiments/uno_qn_result/')
